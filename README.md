...
- Авторизация с помощью JWT-токенов (access + refresh)
...
1. **Data Layer**  
   - Сетевой сервис с Alamofire и поддержкой JWT Auth  
...
3. **Presentation Layer**  
   - UI экраны: авторизация, регистрация, список игр, создание игры, текущая игра, таблица лидеров 
